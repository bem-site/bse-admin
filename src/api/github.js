...
var _ = require('lodash'),
    ...
    Base = inherit({
         ...
         * @returns {*|Object}
         */
        getCommits: function (options, headers, callback) {
            var h = headers,
                o = options,
                c = _.extend({}, o, h ? { headers: h } : {});

            this._logger.verbose('Get commits for: %s %s %s', o.user, o.repo, o.path);
            return this._api.repos.getCommits(c, callback);
        },
         ...
         * @returns {*|Object}
         */
        getBranch: function (options, headers, callback) {
            var h = headers,
                o = options,
                c = _.extend({}, o, h ? { headers: h } : {});

            this._logger.verbose('Get branch for: %s %s %s', o.user, o.repo, o.ref);
            return this._api.repos.getBranch(c, callback);
        },
         ...
         * @returns {*|Object}
         */
        getRepo: function (options, headers, callback) {
            var h = headers,
                o = options,
                c = _.extend({}, o, h ? { headers: h } : {});

            this._logger.verbose('Get repo for: %s %s', o.user, o.repo);
            return this._api.repos.get(c, callback);
        }
    }, {
        CONFIG: {
            version: '3.0.0',
    ...
    /**
     * Custom methods derived from base github api calls
     * @type {*|exports}
     */
    Common = inherit(Base, {
        /**
         ...
         * @returns {*|Object}
         */
        getDefaultBranch: function (options, headers, callback) {
            return this.getRepo(options, headers, function (error, result) {
         ...
         * @returns {*|Object}
         */
        isBranchExists: function (options, headers, callback) {
            return this.getBranch(options, headers, function (error) {
                if (!error) {
                    callback(null, true);
